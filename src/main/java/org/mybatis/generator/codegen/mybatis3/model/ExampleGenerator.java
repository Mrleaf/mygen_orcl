...
if(!my){
	...
	private void addLimit(TopLevelClass topLevelClass,  String name) {  
        CommentGenerator commentGenerator = context.getCommentGenerator();  
        Field field = new Field();  
        field.setVisibility(JavaVisibility.PROTECTED);  
...
//      field.setInitializationString("-1");  
    ...
    private void addFields(TopLevelClass topLevelClass){
    	FullyQualifiedJavaType importlistfqjt = new FullyQualifiedJavaType("java.util.List");
    	topLevelClass.addImportedType(importlistfqjt);
    ...
    private void addField(TopLevelClass topLevelClass, FullyQualifiedJavaType fqjt, String property){
        ...
        
        {
            ...
            if (isTrimStringsEnabled() && isStringColumn(fqjt)) {
