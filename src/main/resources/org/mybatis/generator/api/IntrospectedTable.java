...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_MYBATIS3_XML_MAPPER_PACKAGE_read, // ADD by leaf
        ATTR_MYBATIS3_XML_MAPPER_PACKAGE_write, // ADD by leaf
        ATTR_MYBATIS3_XML_MAPPER_FILE_NAME,
        ATTR_MYBATIS3_XML_MAPPER_FILE_NAME_read, // ADD by leaf
        ATTR_MYBATIS3_XML_MAPPER_FILE_NAME_write, // ADD by leaf
        /** also used as XML Mapper namespace if a Java mapper is generated */
        ATTR_MYBATIS3_JAVA_MAPPER_TYPE,
        ATTR_MYBATIS3_JAVA_MAPPER_TYPE_read, // ADD by leaf
        ATTR_MYBATIS3_JAVA_MAPPER_TYPE_write, // ADD by leaf
    ...
    public String getMyBatis3SqlMapNamespaceRead() {
        String namespace = getMyBatis3JavaMapperTypeRead();
        if (namespace == null) {
            namespace = getMyBatis3FallbackSqlMapNamespace();
        }
    ...
    public String getMyBatis3SqlMapNamespaceWrite() {
        String namespace = getMyBatis3JavaMapperTypeWrite();
        if (namespace == null) {
            namespace = getMyBatis3FallbackSqlMapNamespace();
        }
    ...
    protected void calculateXmlAttributes() {
        ...
        setMyBatis3XmlMapperFileNameRead(calculateMyBatis3ReadXmlMapperFileName());
        setMyBatis3XmlMapperFileNameWrite(calculateMyBatis3WriteXmlMapperFileName());
        setMyBatis3XmlMapperPackage(calculateSqlMapPackage());
        setMyBatis3XmlMapperPackageRead(calculateSqlMapPackageRead());
        setMyBatis3XmlMapperPackageWrite(calculateSqlMapPackageWrite());
    ...
    protected void calculateJavaClientAttributes() {
        ...
        sb.append("Read");
        sb.append("Mapper"); //$NON-NLS-1$
        setMyBatis3JavaMapperTypeRead(sb.toString());
        // 读写分离 ADD by leaf
        sb.setLength(0);
        sb.append(calculateJavaClientInterfacePackage());
        sb.append('.');
        ...
        sb.append("Write");
        sb.append("Mapper"); //$NON-NLS-1$
        setMyBatis3JavaMapperTypeWrite(sb.toString());
    ...
    protected String calculateSqlMapPackageRead() {
        StringBuilder sb = new StringBuilder();
        SqlMapGeneratorConfiguration config = context
                .getSqlMapGeneratorConfiguration();
    ...
    protected String calculateSqlMapPackageWrite() {
        StringBuilder sb = new StringBuilder();
        SqlMapGeneratorConfiguration config = context
                .getSqlMapGeneratorConfiguration();
    ...
    protected String calculateMyBatis3ReadXmlMapperFileName() {
        StringBuilder sb = new StringBuilder();
        sb.append(fullyQualifiedTable.getDomainObjectName());
    ...
    protected String calculateMyBatis3WriteXmlMapperFileName() {
        StringBuilder sb = new StringBuilder();
        sb.append(fullyQualifiedTable.getDomainObjectName());
    ...
    public String getFullyQualifiedTableNameAtRuntime() {
        return internalAttributes
                ...
                .replaceFirst("_"+Constants.T_FROM+"_", java.util.regex.Matcher.quoteReplacement("_${"+Constants.T_TO+"}_"));
    }
    ...
    public String getMyBatis3XmlMapperPackageRead() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_XML_MAPPER_PACKAGE_read);
    }

    public void setMyBatis3XmlMapperPackageRead(String mybatis3XmlMapperPackage) {
        internalAttributes.put(
                InternalAttribute.ATTR_MYBATIS3_XML_MAPPER_PACKAGE_read,
                mybatis3XmlMapperPackage);
    }
    
    public String getMyBatis3XmlMapperPackageWrite() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_XML_MAPPER_PACKAGE_write);
    }

    public void setMyBatis3XmlMapperPackageWrite(String mybatis3XmlMapperPackage) {
        internalAttributes.put(
                InternalAttribute.ATTR_MYBATIS3_XML_MAPPER_PACKAGE_write,
                mybatis3XmlMapperPackage);
    }
    ...
    public String getMyBatis3XmlMapperFileNameRead() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_XML_MAPPER_FILE_NAME_read);
    }

    public void setMyBatis3XmlMapperFileNameRead(String mybatis3XmlMapperFileName) {
        internalAttributes.put(
                InternalAttribute.ATTR_MYBATIS3_XML_MAPPER_FILE_NAME_read,
                mybatis3XmlMapperFileName);
    }
    
    public String getMyBatis3XmlMapperFileNameWrite() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_XML_MAPPER_FILE_NAME_write);
    }

    public void setMyBatis3XmlMapperFileNameWrite(String mybatis3XmlMapperFileName) {
        internalAttributes.put(
     ...
     * @return String
     */
    public String getMyBatis3JavaMapperTypeRead() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_JAVA_MAPPER_TYPE_read);
    }
    /**
     * 读写分离
     * @param mybatis3JavaMapperType
     */
    public void setMyBatis3JavaMapperTypeRead(String mybatis3JavaMapperType) {
        internalAttributes.put(
                InternalAttribute.ATTR_MYBATIS3_JAVA_MAPPER_TYPE_read,
                mybatis3JavaMapperType);
    }
    /**
     * 读写分离
     * @return String
     */
    public String getMyBatis3JavaMapperTypeWrite() {
        return internalAttributes
                .get(InternalAttribute.ATTR_MYBATIS3_JAVA_MAPPER_TYPE_write);
    }
    /**
     * 读写分离
     * @param mybatis3JavaMapperType
     */
    public void setMyBatis3JavaMapperTypeWrite(String mybatis3JavaMapperType) {
        internalAttributes.put(
                InternalAttribute.ATTR_MYBATIS3_JAVA_MAPPER_TYPE_write,
                mybatis3JavaMapperType);
    }
