 ...
 * 
 */
public class WriteXMLMapperGenerator extends AbstractXmlGenerator {

    public WriteXMLMapperGenerator() {
        super();
    }
    ...
    protected XmlElement getSqlMapElement() {
        ...
        XmlElement answerWrite = new XmlElement("mapper"); //$NON-NLS-1$
        String namespace = introspectedTable.getMyBatis3SqlMapNamespaceWrite(); // introspectedTable.getMyBatis3SqlMapNamespace();
        answerWrite.addAttribute(new Attribute("namespace", //$NON-NLS-1$
                namespace));

        context.getCommentGenerator().addRootComment(answerWrite);

        //addResultMapWithoutBLOBsElement(answerWrite);
        //addResultMapWithBLOBsElement(answerWrite);
        
        addExampleWhereClauseElement(answerWrite);
        addMyBatis3UpdateByExampleWhereClauseElement(answerWrite);
        
        //addBaseColumnListElement(answerWrite);
        //addBlobColumnListElement(answerWrite);
        //addSelectByExampleWithBLOBsElement(answerWrite);
        //addSelectByExampleWithoutBLOBsElement(answerWrite);
        //addSelectByPrimaryKeyElement(answerWrite);
        //addCountByExampleElement(answerWrite);
        
        addDeleteByPrimaryKeyElement(answerWrite);
        addDeleteByExampleElement(answerWrite);
        addInsertElement(answerWrite);
        addInsertSelectiveElement(answerWrite);
        
        addUpdateByExampleSelectiveElement(answerWrite);
        addUpdateByExampleWithBLOBsElement(answerWrite);
        addUpdateByExampleWithoutBLOBsElement(answerWrite);
        addUpdateByPrimaryKeySelectiveElement(answerWrite);
        addUpdateByPrimaryKeyWithBLOBsElement(answerWrite);
        addUpdateByPrimaryKeyWithoutBLOBsElement(answerWrite);
