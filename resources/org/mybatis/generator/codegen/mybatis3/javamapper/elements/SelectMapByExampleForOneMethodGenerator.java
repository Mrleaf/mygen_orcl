...
public class SelectMapByExampleForOneMethodGenerator extends
	...
	public void addInterfaceElements(Interface interfaze) {
		...
		{
			//Map<String,Object> selectMapByExampleForOne
			String name = "example";
			Method method = new Method("selectMapByExampleForOne");
